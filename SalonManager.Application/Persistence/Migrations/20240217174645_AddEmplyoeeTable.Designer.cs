...
namespace SalonManager.Application.Persistence.Migrations
{
    ...
    [Migration("20240217174645_AddEmplyoeeTable")]
    partial class AddEmplyoeeTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalonManager.Domain.Entities.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SalonManager.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("SalonManager.Domain.Entities.Employee", "EmployeeAppointment")
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("SalonManager.Domain.Entities.Employee", b =>
                {
                    ...
                    b.HasOne("SalonManager.Domain.Entities.User", "User")
                        .WithMany()
